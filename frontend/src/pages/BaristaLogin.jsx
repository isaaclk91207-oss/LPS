...
export default function BaristaLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    try {
      const res = await api.post("/auth/barista/login", { username, password });
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h2 style={styles.subtitle}>Barista Login</h2>
        ...
        <p style={styles.link}><Link to="/login">Customer Login</Link></p>
      </div>
    </div>
  );
}
